let arrayOfCardOBJ = [
    { nameOfCard: "Enigma", hp: 12, attack: -15, hpUseForSpell: 20, specialAbility: "Paper Seal", manaCost: 70, cardPrice: 0, imgURL: "../../assets/cards/enigma.png", abilityDesc: "Allows to seal away an opponent's card.", description: "Enigma is a dark colored humanoid Stand. Its body is covered in lighter colored standards resembling question marks." },
    { nameOfCard: "Sex Pistols", hp: 11, attack: -16, hpUseForSpell: 15, specialAbility: "Bullet Control", manaCost: 70, cardPrice: 0, imgURL: "../../assets/cards/sex-pistols.png", abilityDesc: "Attack up to 5 consecutive cards to the right of the target.", description: "Sex Pistols is composed of six tiny bullet-like entities living inside a revolver, numbered from 1 to 7, skipping the number 4." },
    { nameOfCard: "Crazy Diamond", hp: 50, attack: -36, hpUseForSpell: 10, specialAbility: "Repair", manaCost: 120, cardPrice: 0, imgURL: "../../assets/cards/crazy-diamond.png", abilityDesc: "Heal a target.", description: "Crazy Diamond is humanoid, with a powerful build and tall stature (about two heads above Josuke)." },
    { nameOfCard: "Star Platinum", hp: 64, attack: -44, hpUseForSpell: 15, specialAbility: "Ora Ora Rush", manaCost: 140, cardPrice: 0, imgURL: "../../assets/cards/star-platinum.png", abilityDesc: "Deal massive damage to a specific target.", description: 'Star Platinum is one of the most human in appearance of humanoid Stands, resembling a tall, well-built man of similar proportions to Jotaro, if not more muscular.' },
    { nameOfCard: "The Hand", hp: 34, attack: -30, hpUseForSpell: 15, specialAbility: "Void Hand", manaCost: 100, cardPrice: 0, imgURL: "../../assets/cards/the-hand.png", abilityDesc: "Hit multiple cards at once near the target.", description: 'The Hand appears as a humanoid figure typically in attire similar to football pads, though it has several spikes jutting from them.' },
    { nameOfCard: "Chariot's Requiem", hp: 68, attack: -40, hpUseForSpell: 20, specialAbility: "Soul Manipulation", manaCost: 140, cardPrice: 0, imgURL: "../../assets/cards/chariot-requiem.png", abilityDesc: "Scramble the target's stats.", description: "It is the evolved form of Silver Chariot after being pierced by the Arrow. Aside from Gold Experience, it is the only other stand known to have a Requiem form." },
    { nameOfCard: "Yellow Temperance", hp: 34, attack: -30, hpUseForSpell: 30, specialAbility: "Consume", manaCost: 100, cardPrice: 0, imgURL: "../../assets/cards/yellow-temperance.png", abilityDesc: "Drain the HP of your target to heal Yellow Temperance.", description: "Yellow Temperance appears as an amorphous, yellow substance, with no mouth, eyes, nose or any other facial features, bound to its user." },
    { nameOfCard: "Surface", hp: 1, attack: 1, hpUseForSpell: 25, specialAbility: "Mimicry", manaCost: 70, cardPrice: 0, imgURL: "../../assets/cards/surface.png", abilityDesc: "Transform into the targeted card.", description: "Surface appears as a human-sized mannequin, with several screws sticking out of its head. While in action, Surface takes on the appearance of another person - matching voice, mannerisms, and clothing - save for screw on the forehead." },
    { nameOfCard: "The World", hp: 60, attack: -48, hpUseForSpell: 60, specialAbility: "DA WARUDO", manaCost: 140, cardPrice: 0, imgURL: "../../assets/cards/the-world.png", abilityDesc: "Destroy all cards of the target's side except the target.", description: "The World is an exceptionally powerful Close-range Stand much like Star Platinum as noted by Noriaki Kakyoin and Jotaro Kujo, but boasting an effective manifestation range of approximately 10 meters." },
    { nameOfCard: "Heaven's Door", hp: 32, attack: -32, hpUseForSpell: 30, specialAbility: "Written Commands", manaCost: 100, cardPrice: 0, imgURL: "../../assets/cards/heaven-door.png", abilityDesc: "Convert an ennemy card into a friendly card or vice versa.", description: "Heaven's Door resembles a small boy similar to Rohan's manga character, Pink Dark Boy. It wears a long overcoat, closed to the end of its torso, and a bow tie." },
    { nameOfCard: "Echoes", hp: 34, attack: -30, hpUseForSpell: 10, specialAbility: "Freeze", manaCost: 100, cardPrice: 0, imgURL: "../../assets/cards/echoes.png", abilityDesc: "Increase the ability and attack cost of a card.", description: "Echoes was born in extremely unusual circumstances. Koichi was stabbed by the Arrow, but due to not having the necessary fighting spirit, should have died; however Josuke Higashikata healed him with Crazy Diamond before he could die and thus Koichi survived, acquiring a Stand in the process." },
    { nameOfCard: "Stray Cat", hp: 12, attack: -17, hpUseForSpell: 10, specialAbility: "Aerokinesis", manaCost: 70, cardPrice: 0, imgURL: "../../assets/cards/stray-cat.png", abilityDesc: "Hit multiple cards at once near the target.", description: "Stray Cat is a Stand bound to a plant shown having a thick stem for its body and big leaves that operate like arms. Its leaves are dexterous enough to grab objects." },
    { nameOfCard: "Aerosmith", hp: 30, attack: -34, hpUseForSpell: 15, specialAbility: "Guns and Bomb", manaCost: 100, cardPrice: 0, imgURL: "../../assets/cards/aerosmith.png", abilityDesc: "Hit multiple cards at once near the target.", description: "Aerosmith is a powerful battle-oriented Stand possessing not only a wide array of powerful weaponry to destroy its enemies." },
    { nameOfCard: "Cheap Trick", hp: 10, attack: -10, hpUseForSpell: 10, specialAbility: "Attachment", manaCost: 70, cardPrice: 0, imgURL: "../../assets/cards/cheap-trick.png", abilityDesc: "Increase the attack cost of a card.", description: "Cheap Trick is obsessed with killing the one whose back it is attached to by making others see it. Its personality is vicious and sadistic." },
    { nameOfCard: "Emperor", hp: 10, attack: -21, hpUseForSpell: 15, specialAbility: "Homing Bullets", manaCost: 70, cardPrice: 0, imgURL: "../../assets/cards/emperor.png", abilityDesc: "Attack a card and increase it's attack cost.", description: "As a gun Stand, Emperor functions as a weapon for Hol Horse. Due to its straightforward nature, Hol Horse must compensate through cooperation with allies to gain the upper hand." },
    { nameOfCard: "Hermit Purple", hp: 15, attack: -5, hpUseForSpell: 10, specialAbility: "Divination", manaCost: 50, cardPrice: 0, imgURL: "../../assets/cards/hermit-purple.png", abilityDesc: "Buff your target's attack. Decrease attack cost and ability cost.", description: "Hermit Purple manifests itself as multiple, purple, thorn-covered vines that spawn from Joseph's hands." },
    { nameOfCard: "Green Day", hp: 50, attack: -35, hpUseForSpell: 25, specialAbility: "Mold Infestation", manaCost: 120, cardPrice: 0, imgURL: "../../assets/cards/green-day.png", abilityDesc: "Damage ALL the cards on the board.", description: "Green Day is an overwhelmingly deadly Stand as its mold has the potential to massacre whole cities." },
    { nameOfCard: "Killer Queen", hp: 65, attack: -42, hpUseForSpell: 15, specialAbility: "Bomb", manaCost: 140, cardPrice: 0, imgURL: "../../assets/cards/killer-queen.png", abilityDesc: "Attack your target. If the target dies after the bomb attack then the nearest cards will die as well.", description: "Killer Queen is unusual among humanoid Stands with complete faces in that its facial expression almost never reflects that of its user, and is instead nearly permanently locked in a wide-eyed, neutral position." },
    { nameOfCard: "Love Deluxe", hp: 32, attack: -32, hpUseForSpell: 15, specialAbility: "Hair Manipulation", manaCost: 100, cardPrice: 0, imgURL: "../../assets/cards/love-deluxe.png", abilityDesc: "Attack your target and increase the target's attack cost and ability cost.", description: "Love Deluxe is bound to the hair of its user Yukako. Because it is bound to an object, Yukako takes no damage from her hair being attacked or cut. This also makes it visible to non-Stand users." },
    { nameOfCard: "Magician's Red", hp: 30, attack: -30, hpUseForSpell: 10, specialAbility: "Pyrokinesis", manaCost: 100, cardPrice: 0, imgURL: "../../assets/cards/magician-red.png", abilityDesc: "Burn your target.", description: "Magician's Red appears as a humanoid figure with a bird-like head. It has a heavily muscular upper body and its feathered legs are sometimes covered in burning flames. Its arms have claws instead of nails and it wears dark bracelets on both of its wrists." },
    { nameOfCard: "Moody Blues", hp: 30, attack: -20, hpUseForSpell: 15, specialAbility: "Rebroadcasting", manaCost: 100, cardPrice: 0, imgURL: "../../assets/cards/moody-blues.png", abilityDesc: "Increase the attack cost of a card twice it's original cost.", description: "Moody Blues is a humanoid Stand of a height and build similar to Abbacchio's. It is clothed from its head to its knees in a semitransparent piece of medium shade, open between the base of its neck and its crotch, and which forms a tent between its head and its shoulders." },
    { nameOfCard: "Purple Haze", hp: 45, attack: -35, hpUseForSpell: 20, specialAbility: "Virus Infection", manaCost: 120, cardPrice: 0, imgURL: "../../assets/cards/purple-haze.png", abilityDesc: "Damage ALL the cards on the board. The untargeted side will receive less damage.", description: "Purple Haze is a humanoid Stand of a height and build similar to Fugo's. Its face and body are patterned by horizontal lozenges of alternating shade, and armor pieces are present on its shoulders, elbows, and knees." },
    { nameOfCard: "Ratt", hp: 10, attack: -15, hpUseForSpell: 10, specialAbility: "Melting Darts", manaCost: 70, cardPrice: 0, imgURL: "../../assets/cards/ratt.png", abilityDesc: "Attack your target. If the target doesn't die, the target's HP will go to 50% of it's maximum.", description: "Ratt has the appearance of a machine resembling a shield with a camera lens in the middle and two supporting legs with a cannon in its back. It appears to have a structure resembling a jaw accompanied by numerous sharp fang-like teeth." },
    { nameOfCard: "Harvest", hp: 30, attack: -25, hpUseForSpell: 20, specialAbility: "Clone", manaCost: 100, cardPrice: 0, imgURL: "../../assets/cards/harvest.png", abilityDesc: "Allows to clone your Harvest on the target's side.", description: "Harvest is one of the few Stands composed of about 500 small units that may act individually." },
    { nameOfCard: "Silver Chariot", hp: 45, attack: -40, hpUseForSpell: 15, specialAbility: "Armor Off", manaCost: 120, cardPrice: 0, imgURL: "../../assets/cards/silver-chariot.png", abilityDesc: "Silver Chariot's attack cost and ability cost decrease by 50% of it's maximum, but it's HP decreases by 50% as well.", description: "In appearance, Silver Chariot looks like a thin, robotic humanoid clad in silver, medieval armor, armed with a cup-hilted rapier. Although Silver Chariot is thin, it wields heavy plate armor spiked at the shoulder pads and elbow pads." },
    { nameOfCard: "Strength", hp: 55, attack: -35, hpUseForSpell: 20, specialAbility: "Power", manaCost: 120, cardPrice: 0, imgURL: "../../assets/cards/strength.png", abilityDesc: "Increases Strength's attack and hp (Attack can only be buffed once).", description: "Strength is a Stand bound to a small yacht, which is then transformed into a gigantic derelict freighter named 'Big Daddy'." },
    { nameOfCard: "Talking Head", hp: 10, attack: -1, hpUseForSpell: 5, specialAbility: "Tongue Control", manaCost: 30, cardPrice: 0, imgURL: "../../assets/cards/talking-head.png", abilityDesc: "Reduces attack of targeted card.", description: "Talking Head appears as a semi-humanoid looking Stand about the size of a human tongue. While its torso looks human, a segmented tail replaces its lower body parts." },
    { nameOfCard: "The Lock", hp: 30, attack: -1, hpUseForSpell: 10, specialAbility: "Guilt Increase", manaCost: 100, cardPrice: 0, imgURL: "../../assets/cards/the-lock.png", abilityDesc: "Increase attack cost depending on the attack of targeted card.", description: "The Lock takes on the appearance of a giant U-Shaped Lock with the character 銭 engraved on the front. It appears hooked onto the target's heart, appearing fused into their chest." },
    { nameOfCard: "The Sun", hp: 10, attack: -15, hpUseForSpell: 20, specialAbility: "Nova Blast", manaCost: 70, cardPrice: 0, imgURL: "../../assets/cards/the-sun.png", abilityDesc: "Destroy ALL cards from board.", description: "Sun appears as a fiery sphere imitating the sun, though believed to be much smaller. It continuously hovers at around 100 meters from the ground." },
    { nameOfCard: "Tower Of Gray", hp: 7, attack: -20, hpUseForSpell: 7, specialAbility: "Quick Stinger", manaCost: 70, cardPrice: 0, imgURL: "../../assets/cards/tower-of-gray.png", abilityDesc: "Cheap attack made to finish off cards.", description: "Tower of Gray is a small and fragile Stand. However, it is also incredibly fast and nimble, and its secondary jaw grants it unsuspected destructive power." },
    { nameOfCard: "White Album", hp: 50, attack: -35, hpUseForSpell: 25, specialAbility: "Ice Lake", manaCost: 120, cardPrice: 0, imgURL: "../../assets/cards/white-album.png", abilityDesc: "Increase the attack cost and ability cost of all cards of the target's side.", description: "White Album is rare among Stands in that it appears as a suit for Ghiaccio to wear. Protecting its user from harm and giving him the potent ability to freeze everything." },
    { nameOfCard: "Hierophant Green", hp: 30, attack: -35, hpUseForSpell: 15, specialAbility: "Emerald Splash", manaCost: 100, cardPrice: 0, imgURL: "../../assets/cards/hierophant-green.png", abilityDesc: "NO ONE CAN JUST DEFLECT THE EMERALD SPLASH.", description: "Hierophant Green is an elastic and remote Stand, capable of being deployed far away from its user and performing actions from a distance." }
]
